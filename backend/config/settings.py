...
# Password hashing — BCrypt per spec §4.1
PASSWORD_HASHERS = [
...
DATABASES = {
    'default': dj_database_url.config(
        default=config('DATABASE_URL', default='postgres://postgres:postgres@localhost:5432/esports_db')
    )
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'app.core.renderers.ApiResponseRenderer',
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Esports Tournament Management Platform API',
    'DESCRIPTION': 'API for managing esports tournaments, teams, and matches',
    'VERSION': '1.0.0',
